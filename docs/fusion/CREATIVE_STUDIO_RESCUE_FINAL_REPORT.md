...
| Tip | SHA |
|-----|-----|
| Feature tip (hubs / auto QR / composition) | `6dcd6b3ba4090042a6b6e2408e5a7b19b923191a` |
| Branch tip at report authoring | run `git rev-parse HEAD` on `tapconnect-creative-studio-rescue` |
