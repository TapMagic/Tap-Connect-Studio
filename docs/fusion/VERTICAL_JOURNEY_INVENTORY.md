...
|----|----------------|---------------------------|------------------------|---------------------|---------------------|---------------|
| **J1** | Organization setup → first successful public Tap | AUTOMATED ACCEPTANCE PASSED (spine) · gaps remain · OWNER ACCEPTANCE PENDING | Tenancy, Brand, Card/Campaign, Groups, TapPoint, Public, Leads, Insights | `P-studio-home`, `P-builder-*`, `P-campaign-group-schedule`, `P-public-seed-tap`, `P-03-lead-capture` | Soft (stock/Clerk optional) | **FIRST** |
...
**Independent verification:** none of J1–J28 have INDEPENDENT VERIFICATION PASSED yet.
