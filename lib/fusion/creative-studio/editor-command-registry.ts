...
const entries = [
  ...
  command("component.editChildren", "Edit contents", "content", ["button", "coupon", "ticket", "container", "badge", "gallery", "form"]), command("resizePolicy.open", "Resize behavior", "resize-policy", ["container", "coupon", "ticket", "gallery"]), command("setup.open", "Setup", "setup", ["coupon", "ticket", "qr", "utility"]), command("map.setup", "Setup", "setup", ["map"]),
