...
export const OBJECT_CAPABILITY_REGISTRY: Readonly<Record<ObjectFamily, ObjectCapabilityDefinition>> = {
  ...
  icon: definition("icon", ["icon.open", "fill.open", "stroke.open", "icon.appearance", "action.open", "motion.open", "transform.position", "more.open"], ["content", "appearance", "action", "motion", ...COMMON], { contentEditor: "icon", appearanceSections: ["fill", "stroke", "stroke-width", "backing-surface", "shadow", "glow", "opacity"] }),
