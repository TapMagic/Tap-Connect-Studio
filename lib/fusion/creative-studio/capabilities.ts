...
export const OBJECT_CAPABILITY_REGISTRY: Readonly<Record<ObjectFamily, ObjectCapabilityDefinition>> = {
  ...
  text: definition("text", ["content.edit", "font.open", "fontSize.quick", "bold.toggle", "italic.toggle", "underline.toggle", "color.open", "material.open", "appearance.open", "action.open", "motion.open", "transform.position", "more.open"], ["content", "text", "appearance", "action", "motion", ...COMMON], { targetLevels: ["parent", "child"], contentEditor: "text", appearanceSections: ["glyph", "material", "outline", "shadow", "glow", "text-box", "effects"], resetSupport: ["content", "typography", "appearance", "transform"] }),
  ...
  icon: definition("icon", ["icon.open", "icon.appearance", "action.open", "motion.open", "transform.position", "more.open"], ["content", "appearance", "action", "motion", ...COMMON], { contentEditor: "icon", appearanceSections: ["artwork", "backing-surface", "shadow", "glow", "opacity"] }),
  ...
  divider: definition("divider", ["divider.style", "divider.thickness", "divider.color", "divider.appearance", "motion.open", "transform.position", "more.open"], ["appearance", "motion", ...COMMON], { appearanceSections: ["line-style", "thickness", "length", "color", "gradient", "caps", "opacity", "spacing"] }),
  badge: definition("badge", ["content.edit", "badge.shape", "material.open", "appearance.open", "action.open", "motion.open", "transform.position", "more.open"], ["content", "text", "surface", "action", "motion", ...COMMON], { contentEditor: "component", childSelection: true, appearanceSections: ["shape", "fill", "material", "border", "shadow", "glow", "shine", "effects"], resetSupport: ["content", "appearance", "transform"] }),
  button: definition("button", ["component.editChildren", "material.open", "appearance.open", "action.open", "motion.open", "transform.position", "more.open"], ["children", "content", "text", "surface", "action", "states", "motion", ...COMMON], { contentEditor: "component", childSelection: true, appearanceSections: ["surface", "material", "states", "border", "corners", "shadow", "glow", "effects"], resetSupport: ["content", "appearance", "action", "motion", "transform"] }),
  // Resize Behavior is Container-authoritative today. Coupon/Ticket store contentComposition
  // children — exposing inert resizePolicy options would break the enabled-control promise.
  coupon: definition("coupon", ["component.editChildren", "appearance.open", "setup.open", "motion.open", "transform.position", "more.open"], ["children", "content", "text", "surface", "setup", "action", "motion", ...COMMON], { contentEditor: "component", childSelection: true, resizePolicies: ["free"], appearanceSections: ["surface", "border", "corners", "shadow", "glow"], resetSupport: ["content", "appearance", "transform", "inserted-preset"] }),
  ticket: definition("ticket", ["component.editChildren", "appearance.open", "setup.open", "motion.open", "transform.position", "more.open"], ["children", "content", "text", "surface", "setup", "action", "motion", ...COMMON], { contentEditor: "component", childSelection: true, resizePolicies: ["free"], appearanceSections: ["surface", "border", "corners", "shadow", "glow"] }),
  map: definition("map", ["map.setup", "map.action", "appearance.open", "transform.position", "more.open"], ["setup", "media", "surface", "action", ...COMMON], { contentEditor: "component", appearanceSections: ["frame", "border", "corners", "shadow", "glow", "opacity"], resetSupport: ["setup", "appearance", "transform"] }),
  ...
  container: definition("container", ["component.editChildren", "layout.open", "size.open", "appearance.open", "resizePolicy.open", "responsive.open", "transform.position", "more.open"], ["children", "layout", "surface", "resize_policy", ...COMMON], { contentEditor: "component", childSelection: true, targetLevels: ["parent", "child"], resizePolicies: ["reflow", "frame", "scale", "fit-content"], appearanceSections: ["fill", "gradient", "media", "pattern", "texture", "material", "border", "corners", "shadow", "glow", "opacity"], resetSupport: ["appearance", "resize-policy", "transform", "inserted-preset"] }),
  group: definition("group", ["component.editChildren", "appearance.open", "ungroup.open", "motion.open", "transform.position", "arrange.open", "more.open", "magicWrite.open"], ["children", "appearance", "action", "motion", ...COMMON], { childSelection: true, appearanceSections: ["color", "material", "effects"], contentEditor: "component" }),
