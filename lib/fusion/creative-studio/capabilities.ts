...
export const OBJECT_CAPABILITY_REGISTRY: Readonly<Record<ObjectFamily, ObjectCapabilityDefinition>> = {
  ...
  group: definition("group", ["component.editChildren", "appearance.open", "motion.open", "transform.position", "arrange.open", "more.open", "magicWrite.open"], ["children", "appearance", "action", "motion", ...COMMON], { childSelection: true, appearanceSections: ["color", "material", "effects"], contentEditor: "component" }),
