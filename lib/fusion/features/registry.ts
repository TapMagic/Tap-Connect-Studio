...
export const FEATURE_DEFINITIONS: FeatureDefinition[] = [
  ...
  },
  {
    ...
    description:
      "Grounded keyword/hashtag suggestions + Brand Pack persistence across Studio surfaces. Contextual only — no primary nav. Live trends = VERIFIED — CREDENTIALS REQUIRED.",
    pillar: "autopilot",
    domainOwner: "ai",
    ux: "assets",
    implementation: "wired",
    ...
    owner: "ai",
    docs: "docs/fusion/IMPLEMENTATION_MODULES.md",
    rollback: "Disable ai.keywords; retain Brand Pack JSON on BrandKit",
  },
  {
    id: "insights.core",
