...
export const FEATURE_DEFINITIONS: FeatureDefinition[] = [
  ...
  {
    id: "comms.email.replies",
    name: "Email & Replies",
    description:
      "TapConnect Email delivery readiness + Reply Routing to verified destinations or TapInbox.",
    pillar: "email",
    domainOwner: "communications",
    ux: ["audience", "experiences"],
    implementation: "wired",
    maturity: "private_beta",
    defaultEnabled: true,
    dependencies: ["comms.email", "comms.inbox"],
    requiredProviders: ["resend"],
    requiredEnvVars: [],
    requiredPermissions: ["email:send"],
    ...
    owner: "comms",
    docs: "docs/fusion/EMAIL_AND_REPLIES_INTEGRATION_FOUNDATION_V1.md",
    rollback: "Hide Email & Replies card; retain stored destinations",
  },
  {
    id: "comms.messaging",
  ...
  {
    id: "card.fuse.offer",
    name: "Card Offer Fuse",
    description:
      "Card Spotlight bound to Campaign-owned offer → claim/keep/lead → mock follow-up + Distribution → Insights proof.",
    pillar: "card",
    domainOwner: "campaign",
    ux: ["experiences", "insights"],
    implementation: "wired",
    maturity: "private_beta",
    defaultEnabled: true,
    dependencies: ["card.builder.v1"],
    requiredProviders: [],
    requiredEnvVars: [],
    requiredPermissions: ["campaigns:edit"],
    surfaces: ["public", "studio", "insights"],
    devices: ["all"],
    analyticsEvents: [
      "card.offer.viewed",
      "card.offer.claimed",
      "card.offer.lead",
      "card.offer.followup_queued",
      "card.offer.distribution_prepared",
    ],
    owner: "product",
    docs: "docs/fusion/CARD_OFFER_FUSE_CONTRACT.md",
    rollback: "Disable card.fuse.offer; retain V1 special_offer link/expand and campaign offer_coupon",
  },
  {
    id: "loyalty.taploop",
