...
export const FEATURE_DEFINITIONS: FeatureDefinition[] = [
  ...
  },
  {
    ...
    description:
      "Durable approved/banned/required Brand Kit vocabulary (BrandVocabularyTerm). Available without live AI credentials.",
    pillar: "autopilot",
    domainOwner: "ai",
    ux: "assets",
    implementation: "wired",
    ...
    requiredEnvVars: [],
    requiredPermissions: ["campaign:edit"],
    surfaces: ["studio", "brand_kit"],
    devices: ["desktop"],
    analyticsEvents: ["keywords.save_brand", "keywords.archive", "keywords.brand_pack.create"],
    owner: "ai",
    docs: "docs/fusion/IMPLEMENTATION_MODULES.md",
    rollback: "Disable brand.vocabulary; retain BrandVocabularyTerm rows read-only",
  },
  {
    id: "ai.keywords",
    name: "Contextual Keywords & Hashtags",
    description:
      "Grounded keyword/hashtag/trigger suggestions + Brand Pack persistence across Studio surfaces. Contextual only — no primary nav. Local grounded generation works without OpenAI. Live AI/trend enrichment = VERIFIED — CREDENTIALS REQUIRED.",
    pillar: "autopilot",
    domainOwner: "ai",
    ux: "assets",
    implementation: "wired",
    ...
    owner: "ai",
    docs: "docs/fusion/IMPLEMENTATION_MODULES.md",
    rollback: "Disable ai.keywords; retain BrandVocabularyTerm + Brand Pack mirror JSON",
  },
  {
    id: "insights.core",
  ...
  {
    id: "connectors.productivity",
    name: "Productivity & Work Management",
    description:
      "Canonical ExternalWorkItem adapters for monday.com, Asana, ClickUp, Planner, Teams, Slack, Notion, Jira, Trello, GitHub, Google Calendar/Drive, Outlook, OneDrive, Airtable, Zapier, Make, and n8n. Mock adapters work without OAuth; live remains VERIFIED — CREDENTIALS REQUIRED.",
    pillar: "integrations",
  ...
  },
  {
    ...
    description:
      "Board/item sync via ExternalWorkItem (subset of Productivity & Work Management).",
    pillar: "integrations",
    domainOwner: "integrations",
    ux: "settings",
    implementation: "wired",
    maturity: "public_beta",
    defaultEnabled: true,
    dependencies: ["connectors.productivity"],
    requiredProviders: ["monday"],
    requiredEnvVars: ["MONDAY_CLIENT_ID", "MONDAY_CLIENT_SECRET"],
    requiredPermissions: ["integrations:manage"],
    surfaces: ["studio"],
    devices: ["desktop"],
    analyticsEvents: ["monday.sync", "monday.webhook", "connector.work_item.created"],
    owner: "integrations",
    docs: "docs/fusion/INTEGRATION_AND_CREDENTIAL_REQUIREMENTS.md",
...

  {
    ...
    name: "TapCanvas",
    description:
      "Shared graph for Sketch / Build / Operate / Analyze & Repair. Linked projections of TapConnect objects including ExternalWorkItem. Automation Team proposals never apply silently.",
    pillar: "experiences",
    domainOwner: "studio",
    ux: "experiences",
    implementation: "wired",
    ...
    owner: "studio",
    docs: "docs/fusion/PILLAR_CATALOG.md",
    rollback: "Feature kill-switch; boards remain in memory until persistence",
  },

  {
    ...
    owner: "distribution",
    docs: "docs/fusion/INTEGRATION_AND_CREDENTIAL_REQUIREMENTS.md",
    rollback: "Use mock mode only / kill-switch",
  },

  {
    id: "tapcast.omnichannel",
    name: "TapCast · Omnichannel",
    description:
      "Channel capability registry + campaign variants + mock publish ladder + TapCanvas distribution graph. Live = VERIFIED — CREDENTIALS REQUIRED. Not OWNER-READY.",
    pillar: "tapcast",
    domainOwner: "distribution",
    ux: "experiences",
    implementation: "wired",
    ...
    devices: ["desktop"],
    analyticsEvents: [
      "tapcast.variant.created",
      "tapcast.variant.published",
      "tapcast.campaign.multi_publish",
    ],
    owner: "distribution",
    docs: "docs/fusion/INTEGRATION_AND_CREDENTIAL_REQUIREMENTS.md",
