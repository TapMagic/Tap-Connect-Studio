    ...
    <div className="space-y-2 rounded-lg border border-border/40 bg-muted/20 p-3">
      ...
      <div className="grid gap-2 sm:grid-cols-2">
        ...
        <div className="space-y-1">
          ...
          <select
            aria-label={`${fieldPrefix} size preset`}
            className="flex h-8 w-full rounded-md border border-input bg-background px-2 text-xs"
        ...
        <div className="space-y-1">
          ...
          <Input
            ...
            min={8}
            max={120}
            aria-label={`${fieldPrefix} size in pixels`}
        ...
        <div className="space-y-1">
          ...
          <select
            aria-label={`${fieldPrefix} alignment`}
            className="flex h-8 w-full rounded-md border border-input bg-background px-2 text-xs"
        ...
        <div className="space-y-1">
          ...
          <select
            aria-label={`${fieldPrefix} letter tracking`}
            className="flex h-8 w-full rounded-md border border-input bg-background px-2 text-xs"
        ...
        <div className="space-y-1">
          ...
          <select
            aria-label={`${fieldPrefix} line height`}
            className="flex h-8 w-full rounded-md border border-input bg-background px-2 text-xs"
            value={
        ...
        <div className="space-y-1">
          ...
          <select
            aria-label={`${fieldPrefix} capitalization`}
            className="flex h-8 w-full rounded-md border border-input bg-background px-2 text-xs"
            value={
      ...
      <div className="space-y-1">
        ...
        <div className="flex items-center gap-2">
          ...
          <Input
            value={value.color ?? ""}
            aria-label={`${fieldPrefix} text color hex`}
      ...
      <div className="space-y-1">
        ...
        <div className="flex gap-1">
          <input
            type="color"
            aria-label={`${fieldPrefix} highlight color`}
          ...
          <Input
            ...
            aria-label={`${fieldPrefix} highlight hex`}
