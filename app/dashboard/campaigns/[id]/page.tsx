  ...
  return (
    <div className="space-y-4">
      ...
      <div className="px-4 pb-6 lg:px-6">
        <WhereUsedPanel
          title="Where this campaign is used"
          emptyLabel="Not assigned to devices or campaign groups — safe to archive without breaking live taps."
          hits={whereUsed?.hits ?? []}
          testId="campaign-where-used"
        />
      </div>
    </div>
  );
